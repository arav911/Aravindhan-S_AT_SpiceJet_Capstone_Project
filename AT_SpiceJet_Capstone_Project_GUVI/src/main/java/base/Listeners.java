...
//			Generating the Extent Report at specified Project Directory path
			String path = "./Test_Results/Reports";
			File directory = new File(path);
			if (!directory.exists())
				directory.mkdirs();
			htmlReporter = new ExtentHtmlReporter(
					path + File.separator + "Aravindhan S_AT_SpiceJet_Capstone_Project_extent_report.html");
			htmlReporter.config().setReportName("Aravindhan S - AT SpiceJet Capstone Project Result");
